...
MESSAGES: dict[str, dict[str, str]] = {
    "it": {
        ...
        "2fa_locked":                  "2FA bloccata. Contatta un amministratore.",
        "2fa_locked_now":              "Troppi tentativi falliti. La 2FA è stata bloccata. Contatta un amministratore.",
        ...
        "2fa_reset_done":              "2FA reimpostata",
        "smtp_not_configured":         "SMTP non configurato o non abilitato",
        "smtp_test_no_recipient":      "Nessun destinatario — imposta email sull'account",
        "smtp_send_failed":            "Invio email fallito",
        "smtp_test_sent":              "Email di test inviata",
        "group_updated":               "Gruppo aggiornato",
        "invalid_bulk_action":         "Azione bulk non valida",
        "bulk_done":                   "Aggiornamento completato",
    },
    "en": {
        ...
        "2fa_locked":                  "2FA is locked. Contact an administrator.",
        "2fa_locked_now":              "Too many failed attempts. 2FA has been locked. Contact an administrator.",
        ...
        "2fa_reset_done":              "2FA reset",
        "smtp_not_configured":         "SMTP not configured or not enabled",
        "smtp_test_no_recipient":      "No recipient — set email on your account",
        "smtp_send_failed":            "Email send failed",
        "smtp_test_sent":              "Test email sent",
        "group_updated":               "Group updated",
        "invalid_bulk_action":         "Invalid bulk action",
        "bulk_done":                   "Update completed",
    },
}
