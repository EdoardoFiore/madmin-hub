/**
 * Settings — personalization, retention, SMTP.
 */
...
export async function render(container) {
      ...
      <div class="container-xl">
        <div class="row row-cards">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><i class="ti ti-palette me-2"></i>${t('settings.tab_personalization')}</h3>
              </div>
              <div class="card-body">
                <div class="row g-3">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input id="s-color-hex" type="text" class="form-control" value="${sys?.primary_color || '#206bc4'}" style="max-width:100px" />
                    </div>
                  </div>
                  <div class="col-md-4">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><i class="ti ti-clock me-2"></i>${t('settings.tab_retention')}</h3>
              </div>
              <div class="card-body">
                <div class="row g-3">
                  <div class="col-md-3">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex align-items-center">
                <h3 class="card-title mb-0"><i class="ti ti-mail me-2"></i>${t('settings.smtp_section')}</h3>
              ...
              <div class="card-body">
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    ...
                    <button id="smtp-test" class="btn btn-outline-secondary ms-2">
                      <i class="ti ti-send me-1"></i>${t('settings.smtp_test')}
                    </button>
                  </div>
                </div>
              </div>
  ...
  container.querySelector('#smtp-test').addEventListener('click', async () => {
    const btn = container.querySelector('#smtp-test');
